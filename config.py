...
class ProductionConfig(Config):
    ...
    def init_app(cls, app):
        ...
        mail_handler = SMTPHandler(
            ...
            fromaddr=cls.SILKAUDIO_MAIL_SENDER,
            toaddrs=[cls.SILKAUDIO_ADMIN],
            subject=cls.SILKAUDIO_MAIL_SUBJECT_PREFIX + ' Application Error',
